...
image = cv2.imread("/home/zerocode/OCR turkish Letters/EAST-Detector-for-text-detection-using-OpenCV-master/images/car_wash.png")
orig = image.copy()
(h,w) = image.shape[:2]
...
net = cv2.dnn.readNet("/home/zerocode/OCR turkish Letters/EAST-Detector-for-text-detection-using-OpenCV-master/frozen_east_text_detection.pb")
